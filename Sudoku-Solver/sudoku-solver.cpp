...
class SudokuFrame{
	...
	*/
	private:void menu(){
		...
		cout<<"You can either:-\n";
		cout<<"\t1. Input the puzzle by entering the values manually. (Enter 1 for this option)\n";
		cout<<"\t2. Input the puzzle by reading a file with values in it. (Enter 2 for this option)\n";
